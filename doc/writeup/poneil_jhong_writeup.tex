...
We want to implement a type of Trie data structure, traversing down the Trie with a problem specification by alternating and matching each of the four sequences. For example, we would traverse the Trie by matching the first character of the first genome, the first number of the top row, the first %...

 (two genomes, top row, first column) 

both of the genomes to align at the same time.  
